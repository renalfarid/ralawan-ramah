...
function populateKorTps(id, nama, alamat) {
  ...
  document.getElementById('konfirmasiData').innerHTML = `
  <div class="flex flex-col gap-4 m-4 p-4 bg-blue-50">
    ...
    <button type="button" id="kirimBtn" onclick="simpanRelawan()" class="mt-4 inline-flex justify-center text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-orage-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
      Kirim
    </button>
  </div>
`;
...
<div class="relative overflow-x-auto">
    ...
    <div class="mt-2 flex justify-center items-center">
     <button type="button" id="pilihPemilihBtn" onclick="populateKorTps('${pemilih[0].id}', \`${pemilih[0].nama}\`, '${pemilih[0].alamatKtp.replace(/'/g, "\\'")}')" class="flex justify-items-center text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center">
        Pilih
